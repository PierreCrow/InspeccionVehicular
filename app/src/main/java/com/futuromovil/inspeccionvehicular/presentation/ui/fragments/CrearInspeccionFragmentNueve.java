...
public class CrearInspeccionFragmentNueve extends BaseFragment
...

      {
          ...
          public View onCreateView(LayoutInflater inflater, ViewGroup container,
              ...
              View x = inflater.inflate(R.layout.crear_inspeccion_nueve, null);
              ...
              if (DatosInicialesFragment.tiposAcividad != null) {
                  ...
                  switch (DatosInicialesFragment.tiposAcividad.size())
                  {
                      case 1:
                          ...
                          {
                              Integer idTipoActividad = DatosInicialesFragment.tiposAcividad.get(8);
                              for (WsActivity wsActivity : TabRegistrarInspeccion.wsGeneralInfo.getWsActivities()) {
