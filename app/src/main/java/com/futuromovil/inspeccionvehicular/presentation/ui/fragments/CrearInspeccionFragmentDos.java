...
public class CrearInspeccionFragmentDos extends BaseFragment
      {
          ...
          public View onCreateView(LayoutInflater inflater, ViewGroup container,
              ...
              View x = inflater.inflate(R.layout.crear_inspeccion_dos, null);
          ...
          void initUI(View x) {
              ...
              if (DatosInicialesFragment.tiposAcividad != null) {
                  ...
                  if(DatosInicialesFragment.tiposAcividad.size()==2)
                  {
                  ...
                  switch (DatosInicialesFragment.tiposAcividad.size())
                  {
                      case 1:
                          ...
                          {
                              Integer idTipoActividad = DatosInicialesFragment.tiposAcividad.get(1);
                              for (WsActivity wsActivity : TabRegistrarInspeccion.wsGeneralInfo.getWsActivities()) {
