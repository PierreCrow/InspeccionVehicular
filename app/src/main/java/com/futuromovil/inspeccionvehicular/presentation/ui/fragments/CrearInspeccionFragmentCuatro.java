...
public class CrearInspeccionFragmentCuatro extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View x = inflater.inflate(R.layout.crear_inspeccion_cuatro, null);
        injectView(x);
        initUI(x);
        loadPictures();
        clickListener();
    ...
    void initUI(View x) {
        ...
        if (DatosInicialesFragment.tiposAcividad != null) {
            ...
            if (DatosInicialesFragment.tiposAcividad.size() == 4) {
            ...
            switch (DatosInicialesFragment.tiposAcividad.size()) {
                case 1:
                    if (DatosInicialesFragment.tiposAcividad.size() > 3) {
                        Integer idTipoActividad = DatosInicialesFragment.tiposAcividad.get(3);
                        for (WsActivity wsActivity : TabRegistrarInspeccion.wsGeneralInfo.getWsActivities()) {
    ...
    void clickListener() {
        tvAtras.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                TabRegistrarInspeccion.viewPager.setCurrentItem(3);
            }
        });
        tvSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                updateActivities();
                TabRegistrarInspeccion.viewPager.setCurrentItem(5);
