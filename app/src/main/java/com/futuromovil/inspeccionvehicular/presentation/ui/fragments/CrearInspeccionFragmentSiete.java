...
public class CrearInspeccionFragmentSiete extends BaseFragment
...

      {
          ...
          public View onCreateView(LayoutInflater inflater, ViewGroup container,
              ...
              View x = inflater.inflate(R.layout.crear_inspeccion_siete, null);
              injectView(x);
              initUI(x);
              loadPictures();
              clickListener();
              ...
              if (DatosInicialesFragment.tiposAcividad != null) {
                  ...
                  switch (DatosInicialesFragment.tiposAcividad.size())
                  {
                      case 1:
                          ...
                          {
                              Integer idTipoActividad = DatosInicialesFragment.tiposAcividad.get(6);
                              for (WsActivity wsActivity : TabRegistrarInspeccion.wsGeneralInfo.getWsActivities()) {
          ...
          void clickListener() {
              ...
              tvSiguiente.setOnClickListener(new View.OnClickListener() {
                  ...
                  public void onClick(View view) {
                      ...
                      updateActivities();
                      TabRegistrarInspeccion.viewPager.setCurrentItem(8);
