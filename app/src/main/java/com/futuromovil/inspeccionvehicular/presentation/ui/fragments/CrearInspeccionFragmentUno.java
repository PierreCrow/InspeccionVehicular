...
public class CrearInspeccionFragmentUno extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View x = inflater.inflate(R.layout.crear_inspeccion_uno, null);
    ...
    void initUI(View x) {
        ...
        if (DatosInicialesFragment.tiposAcividad != null) {
            ...
            if (DatosInicialesFragment.tiposAcividad.size() == 1) {
            ...
            switch (DatosInicialesFragment.tiposAcividad.size()) {
                case 1:
                    if (DatosInicialesFragment.tiposAcividad.size() > 0) {
                        Integer idTipoActividad = DatosInicialesFragment.tiposAcividad.get(0);
                        for (WsActivity wsActivity : TabRegistrarInspeccion.wsGeneralInfo.getWsActivities()) {
    ...
    void clickListener() {
        tvAtras.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                TabRegistrarInspeccion.viewPager.setCurrentItem(0);
            }
        });
        tvSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TabRegistrarInspeccion.viewPager.setCurrentItem(2);
