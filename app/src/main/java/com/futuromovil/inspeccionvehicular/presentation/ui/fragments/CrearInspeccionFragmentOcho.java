...
public class CrearInspeccionFragmentOcho extends BaseFragment
...

      {
          ...
          public View onCreateView(LayoutInflater inflater, ViewGroup container,
              ...
              View x = inflater.inflate(R.layout.crear_inspeccion_ocho, null);
          ...
          void initUI(View x) {
              ...
              if (DatosInicialesFragment.tiposAcividad != null) {
                  ...
                  if(DatosInicialesFragment.tiposAcividad.size()==8)
                  {
                  ...
                  {
                      case 1:
                          if(DatosInicialesFragment.tiposAcividad.size()>7)
                          {
                              Integer idTipoActividad = DatosInicialesFragment.tiposAcividad.get(7);
                              for (WsActivity wsActivity : TabRegistrarInspeccion.wsGeneralInfo.getWsActivities()) {
          ...
          void clickListener() {
              tvAtras.setOnClickListener(new View.OnClickListener() {
                  ...
                  public void onClick(View view) {
                      TabRegistrarInspeccion.viewPager.setCurrentItem(7);
                  }
              });
              tvSiguiente.setOnClickListener(new View.OnClickListener() {
                  ...
                  public void onClick(View view) {
                      ...
                      updateActivities();
                      TabRegistrarInspeccion.viewPager.setCurrentItem(9);
