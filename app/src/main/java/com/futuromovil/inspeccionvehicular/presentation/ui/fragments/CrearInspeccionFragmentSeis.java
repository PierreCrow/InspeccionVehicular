...
public class CrearInspeccionFragmentSeis extends BaseFragment
...

      {
          ...
          public View onCreateView(LayoutInflater inflater, ViewGroup container,
              ...
              View x = inflater.inflate(R.layout.crear_inspeccion_seis, null);
          ...
          void initUI(View x) {
              ...
              if (DatosInicialesFragment.tiposAcividad != null) {
                  ...
                  if(DatosInicialesFragment.tiposAcividad.size()==6)
                  {
                  ...
                  {
                      case 1:
                          if(DatosInicialesFragment.tiposAcividad.size()>5)
                          {
                              Integer idTipoActividad = DatosInicialesFragment.tiposAcividad.get(5);
                              for (WsActivity wsActivity : TabRegistrarInspeccion.wsGeneralInfo.getWsActivities()) {
