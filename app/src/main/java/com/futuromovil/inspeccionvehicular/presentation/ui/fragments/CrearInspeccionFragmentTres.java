...
public class CrearInspeccionFragmentTres extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View x = inflater.inflate(R.layout.crear_inspeccion_tres, null);
        injectView(x);
        initUI(x);
        loadPictures();
        clickListener();
            ...
            switch (DatosInicialesFragment.tiposAcividad.size()) {
                case 1:
                    if (DatosInicialesFragment.tiposAcividad.size() > 2) {
                        Integer idTipoActividad = DatosInicialesFragment.tiposAcividad.get(2);
